...
class _GeminiChatBotState extends State<GeminiChatBot> {
  ...
  Future<void> _sendQuestion(String question) async {
    ...
    final urlRAG = Uri.parse("https://missingbreath-growth.hf.space/RAGChat");
    ...
    switch (context.locale.languageCode) {
      ...
      final ragResponse = await http.post(
        urlRAG,
        headers: {'Content-Type': 'application/json'},
        body: json.encode({'question': question, "language":currentLanguage}),
      );
      ...
      if (ragResponse.statusCode == 200) {
        ...
        setState(() {
          _answers.add("Error: ${ragResponse.reasonPhrase}");
        });
      }
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 8),
             Container(
  width: 45, // slightly smaller circle
  height: 45,
