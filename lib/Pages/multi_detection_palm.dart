...
class MultiPalmDetectionPage extends StatefulWidget {
  @override
  _MultiPalmDetectionPageState createState() => _MultiPalmDetectionPageState();
}

class _MultiPalmDetectionPageState extends State<MultiPalmDetectionPage> {
  File? _image;
...
Future<List<Map<String, dynamic>>> predictMultipleLeaves(XFile imageFile) async {
  try {
    ...
    for (var entry in decoded['output']) {
      ...
      String diseaseName = PalmdiseaseClassNames[predictedClass];
