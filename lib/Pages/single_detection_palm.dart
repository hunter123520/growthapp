...
class SinglePalmDetectionPage extends StatefulWidget {
  @override
  _SinglePalmDetectionPageState createState() => _SinglePalmDetectionPageState();
}

class _SinglePalmDetectionPageState extends State<SinglePalmDetectionPage> {
  File? _image;
  ...
  Future<Map<String, dynamic>> predictDisease(XFile imageFile,BuildContext context) async {
    try {
      final urlClassify = Uri.parse(
        "https://missingbreath-growth.hf.space/palmclassify",
      );
      ...
      final diseaseName = PalmdiseaseClassNames[predictionIndex];
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (_) {
                          final info = Palminfos[_result!["predictionIndex"]];
